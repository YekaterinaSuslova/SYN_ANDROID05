package suslova.yekaterina.syn_android05;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng marker2 = new LatLng(52.2651475, 76.9839443); // Маркер ПКЦМ
    ...
    static final LatLng marker5 = new LatLng(52.2656956, 76.9862424); // Маркер ППВК
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker2).title((getString(R.string.marker2_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.pccm)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                BitmapDescriptorFactory.fromResource(R.drawable.ppvc)).alpha(ALPHA).
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                suslova.yekaterina.syn_android05.MapsActivity.this.onMarkerClick(marker.getId());
                return true;
            }
        });
    }
